...
* [pallets/jinja](https://github.com/pallets/jinja) - The Jinja template engine
...
* [sfyc23/EverydayWechat](https://github.com/sfyc23/EverydayWechat) - 微信助手：1.每日定时给好友发送定制消息。2.机器人自动回复好友。3.群助手功能（例如：查询垃圾分类、天气等）
...
* [aidlearning/AidLearning-FrameWork](https://github.com/aidlearning/AidLearning-FrameWork) - 🔥AidLearning build Linux os running on the Android devices with GUI, Deep-Learning and Python Visual Programming support. One-click Installation🔥
...
* [BayesWitnesses/m2cgen](https://github.com/BayesWitnesses/m2cgen) - Transform ML models into a native code (Java, C, Python, Go) with zero dependencies
