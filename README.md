...
* [aidlearning/AidLearning-FrameWork](https://github.com/aidlearning/AidLearning-FrameWork) - 🔥🔥AidLearning is a powerful mobile AI development platform, AidLearning builds a linux environment supporting GUI, deep learning and visual programming on Android devices..Now Aid supports OpenCL (GPU) for high performance acceleration
