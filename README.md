...
* [BayesWitnesses/m2cgen](https://github.com/BayesWitnesses/m2cgen) - Transform ML models into a native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies
...
* [pgmpy/pgmpy](https://github.com/pgmpy/pgmpy) - Python Library for Inference (Causal and Probabilistic) and learning in Bayesian Networks
...
* [falconry/falcon](https://github.com/falconry/falcon) - The no-nonsense, minimalist web services and app backend framework for Python developers with a focus on reliability and performance at scale.
